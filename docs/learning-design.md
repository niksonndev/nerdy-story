...
Ages **7–9** / 2nd–3rd grade. Independent use: one obvious action, large controls, encouraging copy, no score.

The child should feel they are **exploring a story**, not completing a lesson.

## Three skills, three mechanics

Prompt 03 asks for fluency, comprehension, and vocabulary. We did not bolt three mini-games onto a story. Each mechanic is a reading move inside the same book.

### Vocabulary — produce the meaning

Mystery words sit in running text (canopy, cautious, camouflage / nocturnal). Tap → “Explain what you understand by [word].”
...
| After | Child sees |
| --- | --- |
| Hit | Short why that ties *their* words to the idea |
...
Live-generated prose is a demo risk and a reading-level risk. The educational object is the *child’s* language. We spend model budget on grading that language against a known target.

## What we left out

Timers, stars, multiple choice, “use it in a sentence,” a second playable chapter, and accounts. Those would make a longer demo, not a clearer learning loop.
