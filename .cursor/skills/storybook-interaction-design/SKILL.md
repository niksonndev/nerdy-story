...
- Comprehension resolution paths: same soft miss / transport / reveal shape; on accept or reveal, Keep going / Got it **auto-advances**; never increment words-learned. No local matcher yet — live fail → HTTP fail client path.
